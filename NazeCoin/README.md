...
This token was created by following a tutorial that takes you through the steps of issuing your first ERC20 token on the Ethereum network using a single smart contract and MyEtherWallet.
